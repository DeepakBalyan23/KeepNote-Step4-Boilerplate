...
public class CategoryServiceImpl implements CategoryService {
	...
	public Category updateCategory(Category category, int id) throws CategoryNotFoundException {
		...
		Category cat = (Category)categoryDAO.getCategoryById(id);
		if(cat==null) {
			throw new CategoryNotFoundException("Category not found in service");
		}
		return cat;
	...
	public Category getCategoryById(int categoryId) throws CategoryNotFoundException {
		Category cat = (Category)categoryDAO.getCategoryById(categoryId);
		if(cat==null) {
			throw new CategoryNotFoundException("Category not found in service");
		}
		return cat;
